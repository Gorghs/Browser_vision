import type { IngestEventsRequest, IngestEventsResponse } from '@vab/types';
...
export class BackendClient {
  ...
  async ingest(payload: DeliveryPayload): Promise<IngestEventsResponse> {
    ...
    // 429 and 5xx are transient by definition. Everything else means this batch
    // will never be accepted in its current form.
